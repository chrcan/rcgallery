...
return [
    ...
    'types' => [
        '1' => ['showitem' => 'file, caption, --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:language, sys_language_uid, l10n_parent, l10n_diffsource'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
            ...
            'config' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getFileFieldTCAConfig(
                ...
                [
                    ...
                    'foreign_match_fields' => [
                        'fieldname' => 'file',
                        'tablenames' => 'tx_rcgallery_domain_model_image',
